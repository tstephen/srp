...
public class RunCalculationsExternally3 {
    ...
    private static final Logger LOGGER = LoggerFactory
            .getLogger(RunCalculationsExternally3.class);
    ...
    public RunCalculationsExternally3() throws IOException {
...
//                sendData(connection, payload);
    ...
    public static final void main(String[] args) {
        ...
        try {
            RunCalculationsExternally3 svc = new RunCalculationsExternally3();
