...
//      console.info('sorted:'+column);
    ...
    stdPartials: [
      ...
      { "name": "navbar", "url": "/partials/intervention-navbar.html"},
      { "name": "profileArea", "url": "/partials/profile-area.html"},
      { "name": "sidebar", "url": "/partials/sidebar.html"},
      { "name": "titleArea", "url": "/partials/title-area.html"},
      { "name": "interventionGridSect", "url": "/partials/intervention-grid-sect.html"},
      { "name": "interventionListSect", "url": "/partials/intervention-list-sect.html"},
      { "name": "interventionCurrentSect", "url": "/partials/intervention-current-sect.html"},
      { "name": "interventionTimeModal", "url": "/partials/intervention-time-modal.html"}
    ],
    sumShare: function(i) {
