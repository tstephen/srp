...
//      console.info('sorted:'+column);
    ...
    stdPartials: [
      { "name": "navbar", "url": "/partials/parameter-navbar.html"},
      { "name": "profileArea", "url": "/partials/profile-area.html"},
      { "name": "sidebar", "url": "/partials/sidebar.html"},
      { "name": "titleArea", "url": "/partials/title-area.html"},
      { "name": "parameterListSect", "url": "/partials/parameter-list-sect.html"},
      { "name": "parameterCurrentSect", "url": "/partials/parameter-current-sect.html"}
    ],
    title: "Parameters"
  },
  add: function () {
  ...
  showResults: function() {
    $('#parametersTableToggle').addClass('glyphicon-triangle-bottom').removeClass('glyphicon-triangle-right');
    $('#currentSect').slideUp();
  ...
  toggleResults: function() {
    ...
    $('#parametersTableToggle').toggleClass('glyphicon-triangle-bottom').toggleClass('glyphicon-triangle-right');
