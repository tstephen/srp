...
//      console.info('sorted:'+column);
    ...
    stdPartials: [
      { "name": "navbar", "url": "/partials/organisation-type-navbar.html"},
      { "name": "profileArea", "url": "/partials/profile-area.html"},
      { "name": "sidebar", "url": "/partials/sidebar.html"},
      { "name": "titleArea", "url": "/partials/title-area.html"},
      { "name": "organisationTypeListSect", "url": "/partials/organisation-type-list-sect.html"},
      { "name": "organisationTypeCurrentSect", "url": "/partials/organisation-type-current-sect.html"}
    ],
...
//      console.log('ready to save organisationType'+JSON.stringify(tmp)+' ...');
  ...
  showResults: function() {
    $('#organisationTypesTableToggle').addClass('glyphicon-triangle-bottom').removeClass('glyphicon-triangle-right');
    $('#currentSect').slideUp();
  ...
  toggleResults: function() {
    ...
    $('#organisationTypesTableToggle').toggleClass('glyphicon-triangle-bottom').toggleClass('glyphicon-triangle-right');
