...
@WebAppConfiguration
public class SurveyReturnControllerITest {
    ...
    public void testLifecycle() {
        ...
        assertEquals(Sdu1617.getSurvey().questionCodes().size(), rtn.answers().size());
        ...
        ArrayList<Answer> revisedAnswers = new ArrayList<Answer>();
        for (Answer a : rtn2.answers()) {
            assertEquals(ANSWERS[rtn.answers().indexOf(a)], a.response());
            revisedAnswers.add(a.response("REVISED"+ANSWERS[rtn.answers().indexOf(a)]));
        }
        assertEquals(Sdu1617.getSurvey().questionCodes().size(), revisedAnswers.size());
        ...
        assertEquals(Sdu1617.getSurvey().questionCodes().size(), rtn3.answers().size());
        ...
        assertEquals(SDU1617.getSurvey().questionCodes().size(), rtn2.answers().size());
