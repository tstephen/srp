...
public class QuestionCsvImporterTest {
    ...
    public void testImport() {
        try {
            ...
            assertEquals(153, questions.size());

             // assert expected values of record 75 (first currently complete)
            ...
            Question question = questions.get(75);
            ...
            question = questions.get(66);
            assertEquals("CARBON_REDUCTION_BASE_YEAR", question.name());
            assertEquals("Which year is it?", question.label());
