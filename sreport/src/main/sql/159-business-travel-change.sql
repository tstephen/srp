update SR_QUESTION 
  ...
  where name = 'BIZ_MILEAGE_ROADS';
update SR_QUESTION set name = 'BIZ_MILEAGE_ROADS_COST',
 ...
 update SR_CAT set questions = replace(questions, '_3RD_PTY_ROAD_MILES','BIZ_MILEAGE_ROADS_COST');
