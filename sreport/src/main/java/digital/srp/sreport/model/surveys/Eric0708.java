 ...
 */
public class Eric0708 implements EricQuestions, SurveyFactory {
    public static final String PERIOD = "2007-08";
    public static final String ID = "ERIC-"+PERIOD;
    private static final Eric0708 survey = new Eric0708();
