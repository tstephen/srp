 ...
 */
public class Sdu2021 implements SurveyFactory {

    public static final String PERIOD = "2020-21";
    public static final String ID = "SDU-"+PERIOD;
    private static final Sdu2021 sdu2021 = new Sdu2021();
    ...
    public Survey getSurvey() {
        ...
        SurveyCategory catWaste = new SurveyCategory()
                ...
                .questionEnums(
                        ...
                        Q.PAPER_USED,
                        Q.WASTE_CLINICAL_INCINERATED,
                        Q.ALT_WASTE_DISPOSAL_WEIGHT,
                        Q.WASTE_OFFENSIVE,
                        Q.LANDFILL_WEIGHT,
                        Q.RECYCLING_WEIGHT,
                        Q.WASTE_FOOD,
        ...
        SurveyCategory catFleetTravel = new SurveyCategory()
                .name("Fleet Travel")
                .questionEnums(
                        Q.CAR_PETROL_USED,
                        Q.CAR_DIESEL_USED,
        ...
        SurveyCategory catInhalers = new SurveyCategory()
                .name("Inhalers")
                .questionEnums(
                        Q.MDI,
                        Q.DPI,
        ...
        Survey survey = new Survey().name(ID).status("Draft")
                ...
                .categories(catOrg, catPolicy, catPerf, catSize,
                        ...
                        catFleetTravel, catBizTravel, catOtherTravel,
                        catAirPollution, catSocialValue, catGases, catInhalers,
    ...
    public Q[] getQs() {
        ...
        list.add(Q.CAR_PETROL_WTT_CO2E);
        list.add(Q.CAR_MILES_UNKOWN_FUEL_CO2E);
        list.add(Q.OWNED_LEASED_LOW_CARBON_CO2E);
