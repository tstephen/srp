...
public interface SduQuestions {
    ...
    Q[] FOOTPRINT_2017_PCT_HDRS = new Q[] {
            Q.CORE_CO2E_PCT,
            Q.COMMISSIONING_CO2E_PCT,
            Q.PROCUREMENT_2017_CO2E_PCT,
            Q.COMMUNITY_CO2E_PCT
    };
    ...
    Q[] WASTE_HDRS_POST2020 = new Q[] {
            Q.DURABLES_INTERNAL_REUSE, Q.DURABLES_EXTERNAL_REUSE,
            Q.PAPER_USED, Q.WASTE_CLINICAL_INCINERATED,
            Q.ALT_WASTE_DISPOSAL_WEIGHT, Q.WASTE_OFFENSIVE, Q.LANDFILL_WEIGHT,
            Q.RECYCLING_WEIGHT, Q.WASTE_CONFIDENTIAL,
            Q.WASTE_FOOD, Q.WASTE_TEXTILES,
            Q.INCINERATION_WEIGHT, Q.WASTE_PROCESSED_ON_SITE, Q.WEEE_WEIGHT
    };
    ...
    Q[] WASTE_CO2E_HDRS_POST2020 = new Q[] { Q.DURABLES_INTERNAL_REUSE_CO2E,
            Q.DURABLES_EXTERNAL_REUSE_CO2E, Q.PAPER_USED_CO2E,
            Q.WASTE_CLINICAL_INCINERATED_CO2E, Q.ALT_WASTE_DISPOSAL_WEIGHT_CO2E,
            Q.WASTE_OFFENSIVE_CO2E, Q.LANDFILL_CO2E,
            Q.RECYCLING_CO2E, Q.WASTE_CONFIDENTIAL_CO2E, Q.WASTE_FOOD_CO2E,
            Q.WASTE_TEXTILES_CO2E, Q.INCINERATION_CO2E,
            Q.WASTE_PROCESSED_ON_SITE_CO2E, Q.WEEE_WEIGHT_CO2E
    };

    Q[] BIZ_MILEAGE_ACTIVE_PUBLIC_HDRS = new Q[] {
            Q.RAIL_MILES, Q.BUS_MILES, Q.TAXI_MILES
    };

    Q[] BIZ_MILEAGE_HDRS = new Q[] {
            Q.BIZ_MILEAGE_ROAD,
            Q.FLEET_ROAD_MILES,
    ...
    Q[] BIZ_MILEAGE_CO2E_HDRS = new Q[] {
            ...
            Q.BIZ_MILEAGE_BUS_CO2E,
            Q.BIZ_MILEAGE_TAXI_CO2E
    };
    ...
    Q[] ENERGY_HDRS = new Q[] {
            Q.GAS_USED, Q.OIL_USED, Q.COAL_USED,
            Q.STEAM_USED, Q.HOT_WATER_USED,
            Q.ELEC_USED, Q.ELEC_TOTAL_RENEWABLE_USED
    };
    ...
    Q[] SDU_PROFILE_CO2E_HDRS = new Q[] {
            ...
            Q.STAFF_COMMUTE_MILES_CO2E,
            /* procurement */
            Q.BIZ_SVCS_CO2E, Q.CAPITAL_CO2E,
    ...
    Q[] ECLASS_PROFILE_SPEND_HDRS = new Q[] {
            ...
            Q.LAB_EQUIPT_AND_SVCS,
            Q.HOTEL_EQUIPT_MATERIALS_AND_SVCS,
    ...
    Q[] ECLASS_PROFILE_CO2E_HDRS = new Q[] {
            /* community */
            Q.PATIENT_AND_VISITOR_MILEAGE_CO2E,
            Q.STAFF_COMMUTE_MILES_CO2E,
            /* procurement */
    ...
    Q[] BENCHMARK_BY_POPULATION_HDRS = new Q[] {
            ...
            Q.TOTAL_PROCUREMENT_2017_CO2E_BY_POP,
            Q.TOTAL_COMMUNITY_CO2E_BY_POP
    };
    ...
    Q[] BENCHMARK_BY_WTE_HDRS = new Q[] {
            Q.TOTAL_CORE_CO2E_BY_WTE,
            Q.TOTAL_COMMISSIONING_CO2E_BY_WTE,
            Q.TOTAL_PROCUREMENT_2017_CO2E_BY_WTE,
            Q.TOTAL_COMMUNITY_CO2E_BY_WTE
    };

    Q[] BENCHMARK_BY_BEDS_HDRS = new Q[] {
            Q.TOTAL_CORE_CO2E_BY_BEDS,
            Q.TOTAL_COMMISSIONING_CO2E_BY_BEDS,
            Q.TOTAL_PROCUREMENT_2017_CO2E_BY_BEDS,
            Q.TOTAL_COMMUNITY_CO2E_BY_BEDS
    };

    Q[] BENCHMARK_BY_PATIENT_CONTACTS_HDRS = new Q[] {
            Q.TOTAL_CORE_CO2E_BY_PATIENT_CONTACT,
            Q.TOTAL_COMMISSIONING_CO2E_BY_PATIENT_CONTACT,
            Q.TOTAL_PROCUREMENT_2017_CO2E_BY_PATIENT_CONTACT,
            Q.TOTAL_COMMUNITY_CO2E_BY_PATIENT_CONTACT
    };

    Q[] BENCHMARK_BY_OPEX_HDRS = new Q[] {
            Q.TOTAL_CORE_CO2E_BY_OPEX,
            Q.TOTAL_COMMISSIONING_CO2E_BY_OPEX,
            Q.TOTAL_PROCUREMENT_2017_CO2E_BY_OPEX,
            Q.TOTAL_COMMUNITY_CO2E_BY_OPEX
    };
