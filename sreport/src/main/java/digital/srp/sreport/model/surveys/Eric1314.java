 ...
 */
public class Eric1314 implements EricQuestions, SurveyFactory {
    public static final String PERIOD = "2013-14";
    public static final String ID = "ERIC-"+PERIOD;
    private static final Eric1314 survey = new Eric1314();
    ...
    private List<Q> getDerivedQs() {
        ...
        list.add(Q.ALT_WASTE_DISPOSAL_WEIGHT_CO2E);
