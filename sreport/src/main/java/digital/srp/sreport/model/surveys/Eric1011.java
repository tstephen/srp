 ...
 */
public class Eric1011 implements EricQuestions, SurveyFactory {
    public static final String PERIOD = "2010-11";
    public static final String ID = "ERIC-"+PERIOD;
    private static final Eric1011 survey = new Eric1011();
