 ...
 */
public class Eric1213 implements EricQuestions, SurveyFactory {
    public static final String PERIOD = "2012-13";
    public static final String ID = "ERIC-"+PERIOD;
    private static final Eric1213 survey = new Eric1213();
