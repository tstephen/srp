 ...
 */
public class Eric1112 implements EricQuestions, SurveyFactory {
    public static final String PERIOD = "2011-12";
    public static final String ID = "ERIC-"+PERIOD;
    private static final Eric1112 survey = new Eric1112();
