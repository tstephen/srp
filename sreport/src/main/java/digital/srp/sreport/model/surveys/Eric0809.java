 ...
 */
public class Eric0809 implements EricQuestions, SurveyFactory {
    public static final String PERIOD = "2008-09";
    public static final String ID = "ERIC-"+PERIOD;
    private static final Eric0809 survey = new Eric0809();
