    ...
    public Survey getSurvey() {
        SurveyCategory catOrg = new SurveyCategory()
                ...
                .questions(Arrays.asList(
                        ...
                        new SurveyQuestion().q(Q.FLOOR_AREA).label("Total gross internal floor space").required(true).type("number").unit("m2"),
                        new SurveyQuestion().q(Q.POPULATION).label("Registered population or population served").required(true).type("number").unit("people"),
                        new SurveyQuestion().q(Q.NO_STAFF).label("Total no. of staff employed").required(true).type("number").unit("WTE"),
                        new SurveyQuestion().q(Q.NO_BEDS).label("Total no. occupied beds").required(true).type("number"),
                        new SurveyQuestion().q(Q.NO_PATIENT_CONTACTS).label("Total Patient Contacts").required(true).type("number")
                ));
        ...
        SurveyCategory catPolicy = new SurveyCategory()
                ...
                .questions(Arrays.asList(
                        ...
                        new SurveyQuestion().q(Q.QUANT_ES_IMPACTS).label("What are the qualitative or quantified social and environmental impacts?").required(true),
                        new SurveyQuestion().q(Q.QUANT_TRAVEL_IMPACTS).label("Does your organisation quantify the health impacts of travel and transport?").required(true).type("yesno"),
                        new SurveyQuestion().q(Q.MOD_SLAVERY).label("If your organisation has a Modern Slavery statement, what is it?").required(true).type("yesno"),
                        new SurveyQuestion().q(Q.SIA).label("Does your business case process include a Sustainability Impact Assessment?").required(true).type("yesno")
                ));
        ...
        SurveyCategory catPerf = new SurveyCategory()
                ...
                .questions(Arrays.asList(
                        ...
                        new SurveyQuestion().q(Q.CARBON_REDUCTION_TARGET_PCT).label("What is the percentage reduction target?").required(true).type("number").unit("%"),
                        ...
                        new SurveyQuestion().q(Q.BOARD_SUSTAINABILITY_AS_RISK).label("Does your board consider sustainability issues as part of its risk management process?").required(true).type("yesno"),
                        ...
                        new SurveyQuestion().q(Q.PROVIDERS_COMMISSIONED).label("We commission services from the following providers").required(true)
                ));
        ...
        SurveyCategory catFinancial = new SurveyCategory()
                ...
                .questions(Arrays.asList(
                        ...
                        new SurveyQuestion().q(Q.CAPITAL_SPEND).label("Capital Spend").required(false).type("number").unit("£,000")
                ));
        ...
        SurveyCategory catEnergy = new SurveyCategory()
                ...
                .questions(Arrays.asList(
                        ...
                        new SurveyQuestion().q(Q.ELEC_USED_LOCAL).label("Electricity Consumed - local").required(false).type("number").unit("kWh"),
                        ...
                        new SurveyQuestion().q(Q.ELEC_USED_GREEN_TARIFF).label("Electricity Consumed - green energy tariff").required(false).type("number").unit("kWh"),
                        new SurveyQuestion().q(Q.ELEC_USED_3RD_PTY_RENEWABLE).label("Electricity Consumed - third party owned renewable").required(false).type("number").unit("kWh"),
                        new SurveyQuestion().q(Q.RENEWABLE_USED).label("Non-fossil fuel Consumed - renewable").required(false).type("number").unit("kWh"),
        ...
        SurveyCategory catWaste = new SurveyCategory()
                .name("Waste")
                .questions(Arrays.asList(
                        new SurveyQuestion().q(Q.OTHER_RECOVERY_WEIGHT).label("Other Recovery weight").required(false).type("number").unit("tonnes"),
                        new SurveyQuestion().q(Q.INCINERATION_WEIGHT).label("Incineration disposal weight").required(false).type("number").unit("tonnes"),
        ...
        SurveyCategory catWater = new SurveyCategory()
                .name("Water")
                .questions(Arrays.asList(
                        new SurveyQuestion().q(Q.WASTE_WATER).label("Waste water").required(false).type("number").unit("m3")
                ));
        ...
        SurveyCategory catOtherTravel = new SurveyCategory()
                ...
                .questions(Arrays.asList(
                        ...
                        new SurveyQuestion().q(Q.STAFF_COMMUTE_MILES_PP).label("Staff commute - Average annual distance travelled by road to work").required(false).type("number").unit("miles"),
                         // TODO calculated value within input
//                        new SurveyQuestion().label("Staff commute - Average annual distance travelled by road to work").required(false).type("number").unit("miles"),
                        new SurveyQuestion().q(Q.HEALTH_IMPACT_OF_TRAVEL).label("Health impacts of travel and transport associated with provider activities").required(false).unit("QALY")
                ));
        ...
        SurveyCategory catGases = new SurveyCategory()
                ...
                .questions(Arrays.asList(
                        ...
                        new SurveyQuestion().q(Q.SEVOFLURANE).label("Sevoflurane - liquid").required(false).type("number").unit("litres"),
                        ...
                        new SurveyQuestion().q(Q.PORTABLE_NITROUS_OXIDE_MIX_MATERNITY).label("Maternity Manifold nitrous oxide and oxygen 50/50 split - gas").required(false).type("number").unit("litres")
        ...
        SurveyCategory catAdditional = new SurveyCategory()
                ...
                .questions(Arrays.asList(
                        ...
                        new SurveyQuestion().q(Q.LEASED_ASSETS_ENERGY_USE).label("Leased Assets Energy Use(Upstream - Gas, Coal & Electricity)").required(false).unit("kWh"),
                        new SurveyQuestion().q(Q.GREEN_TARIFF_ADDITIONAL_PCT).label("Percentage of green tariff supply proven as additional").required(false).type("number").unit("%"),
                        new SurveyQuestion().q(Q.THIRD_PARTY_ADDITIONAL_PCT).label("Percentage of third party owned supply proven as additional").required(false).type("number").unit("%")
                ));
        ...
        SurveyCategory catSpendProfile = new SurveyCategory()
                ...
                .questions(Arrays.asList(
                        ...
                        new SurveyQuestion().q(Q.PHARMA_SPEND).label("Pharmaceuticals").required(false).unit("£"),
                        new SurveyQuestion().q(Q.TRAVEL_SPEND).label("Travel").required(false).type("number").unit("£"),
                        new SurveyQuestion().q(Q.COMMISSIONING_SPEND).label("Commissioning").required(false).unit("£")
                ));
        ...
        Survey survey = new Survey().name(ID).status("Draft")
                ...
                .categories(Arrays.asList(catOrg, catPolicy, catPerf,
                        ...
                        catAdditional, catSpendProfile, catCalcs));
        return survey;
    }
}