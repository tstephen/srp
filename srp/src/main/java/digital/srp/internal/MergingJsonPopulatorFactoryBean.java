...
public class MergingJsonPopulatorFactoryBean extends
    ...
    protected ResourceReaderRepositoryPopulator createInstance() {
        ...
        ResourceReaderRepositoryPopulator initializer = new MergingJsonResourceReaderRepositoryPopulator(
                getResourceReader());
    ...
    protected ResourceReader getResourceReader() {
        return new Jackson2ResourceReader(objectMapper);
    }
}
